...
- PostgreSQL reports 400 total connections and three superuser-reserved slots:
  a 397-connection non-superuser ceiling. The 28-connection production
...
- Cloud SQL is the sole durable authority. Stop if fewer than 28 connections are
...
3. Record the current Cloud SQL settings and query:
   ...
   Prove at least 28 connections remain usable by the application and operator
...
5. Re-establish database roles and the measured 28-connection reservation.
