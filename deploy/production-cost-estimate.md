...
Expected Google Cloud infrastructure cost is approximately **$228/month USD**,
with a **$250/month planning budget**, before credits, free tiers, committed-use
discounts, taxes, and Telnyx charges.

This is a rate-card model updated 2026-08-08, not a billing quote or deployed
...
| Warm web + portal + ingress | three request-billed minimum instances, idle baseline | $29.57 |
| Realtime | one warm instance; 176 active hours and 554 idle hours | $23.48 |
| Request bursts and migration | low observed pilot usage allowance | $2.00 |
| Global HTTPS load balancer | first five forwarding rules at $0.025/hour | $18.25 |
...
| **Expected total** | before free tiers or discounts | **$228.29** |
...
The $250 planning budget leaves about $22 for higher active-request time,
