...
func TestBookingDailyTotalIncludesUnclassifiedCallsAndPoolsDurations(t *testing.T) {
	...
	if daily.Bookings != 3 || daily.Calls != 5 || daily.SearchEvidenceCalls != 4 || daily.Searched != 4 || daily.Converted != 4 || daily.DurationSamples != 4 || daily.P50 == nil || *daily.P50 != 250 || daily.P90 == nil || *daily.P90 != 370 {
