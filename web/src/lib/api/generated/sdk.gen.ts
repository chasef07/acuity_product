...
/**
 * Read the exact non-converting booking cohort as a Platform Operator.
 */
export const queryBookingNonConversions = <ThrowOnError extends boolean = false>(options: Options<QueryBookingNonConversionsData, ThrowOnError>): RequestResult<QueryBookingNonConversionsResponses, QueryBookingNonConversionsErrors, ThrowOnError> => (options.client ?? client).post<QueryBookingNonConversionsResponses, QueryBookingNonConversionsErrors, ThrowOnError>({
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
