...
/**
 * List AI calls within authorized Locations.
 */
export const queryAgentCalls = <ThrowOnError extends boolean = false>(options: Options<QueryAgentCallsData, ThrowOnError>): RequestResult<QueryAgentCallsResponses, QueryAgentCallsErrors, ThrowOnError> => (options.client ?? client).post<QueryAgentCallsResponses, QueryAgentCallsErrors, ThrowOnError>({
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Read a staff-facing conversation and its issue flag.
 */
export const getAgentCall = <ThrowOnError extends boolean = false>(options: Options<GetAgentCallData, ThrowOnError>): RequestResult<GetAgentCallResponses, GetAgentCallErrors, ThrowOnError> => (options.client ?? client).get<GetAgentCallResponses, GetAgentCallErrors, ThrowOnError>({
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
...
/**
 * Flag a call for Acuity review; the first report is preserved.
 */
export const flagAgentCallIssue = <ThrowOnError extends boolean = false>(options: Options<FlagAgentCallIssueData, ThrowOnError>): RequestResult<FlagAgentCallIssueResponses, FlagAgentCallIssueErrors, ThrowOnError> => (options.client ?? client).put<FlagAgentCallIssueResponses, FlagAgentCallIssueErrors, ThrowOnError>({
    security: [{
            key: 'bearerAuth',
            scheme: 'bearer',
            type: 'http'
