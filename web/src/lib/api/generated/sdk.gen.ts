 ...
 */
export const issueCallingRecordingPlayback = <ThrowOnError extends boolean = false>(options: Options<IssueCallingRecordingPlaybackData, ThrowOnError>) => (options.client ?? client).post<IssueCallingRecordingPlaybackResponses, IssueCallingRecordingPlaybackErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
 ...
 */
export const reviewAiInteractionOutcome = <ThrowOnError extends boolean = false>(options: Options<ReviewAiInteractionOutcomeData, ThrowOnError>) => (options.client ?? client).post<ReviewAiInteractionOutcomeResponses, ReviewAiInteractionOutcomeErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Select one oldest attached receipt from one exact quarantine group.
 */
export const getOperatorProviderReceiptQuarantineCandidate = <ThrowOnError extends boolean = false>(options: Options<GetOperatorProviderReceiptQuarantineCandidateData, ThrowOnError>) => (options.client ?? client).get<GetOperatorProviderReceiptQuarantineCandidateResponses, GetOperatorProviderReceiptQuarantineCandidateErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Read bounded durable status for one attached provider receipt.
 */
export const getOperatorProviderReceiptRecoveryStatus = <ThrowOnError extends boolean = false>(options: Options<GetOperatorProviderReceiptRecoveryStatusData, ThrowOnError>) => (options.client ?? client).get<GetOperatorProviderReceiptRecoveryStatusResponses, GetOperatorProviderReceiptRecoveryStatusErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Terminally resolve one attached receipt proven unsafe to replay.
 */
export const resolveOperatorProviderReceipt = <ThrowOnError extends boolean = false>(options: Options<ResolveOperatorProviderReceiptData, ThrowOnError>) => (options.client ?? client).post<ResolveOperatorProviderReceiptResponses, ResolveOperatorProviderReceiptErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
