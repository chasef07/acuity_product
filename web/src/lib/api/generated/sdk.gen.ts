...
/**
 * Clear per-User unread state for every authorized Message Thread at one exact phone.
 */
export const markEngagementRead = <ThrowOnError extends boolean = false>(options: Options<MarkEngagementReadData, ThrowOnError>) => (options.client ?? client).post<MarkEngagementReadResponses, MarkEngagementReadErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Explicitly acknowledge currently answered inbound Texts for one exact phone.
 */
export const markEngagementTextHandled = <ThrowOnError extends boolean = false>(options: Options<MarkEngagementTextHandledData, ThrowOnError>) => (options.client ?? client).post<MarkEngagementTextHandledResponses, MarkEngagementTextHandledErrors, ThrowOnError>({
    security: [{ scheme: 'bearer', type: 'http' }],
...
/**
 * Add an immutable staff-authored note to one exact-phone Engagement History.
 */
...
/**
 * Record that the current User reviewed a Task without completing it.
 */
...
/**
 * Query phone-led Message Threads across the requested authorized Location scope.
 */
